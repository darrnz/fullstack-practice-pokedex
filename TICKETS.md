...
- [ ] Guardar en `pokedeck-udi/docs/diagram.*`.
...
- [ ] Subir diseño a `pokedeck-udi/docs/model-design.md`.
...
**Descripción**
Implementar los modelos acordados en `pokedeck-udi/prisma/schema.prisma`.
...
**Descripción**
Leer `pokedeck-udi/src/server.js` y `pokedeck-udi/src/routes/health.routes.js` para entender cómo montar rutas y middlewares.
...
- [ ] Implementar rutas en `pokedeck-udi/src/routes/demo.routes.js` usando Prisma.

**Labels**: backend, api


### API-03 – Definir el contrato de endpoints (`pokedeck-udi/docs/api-contract.md`)

**Descripción**
Documentar los endpoints planeados con método, URL, parámetros/ejemplos y respuestas.

**Checklist**
- [ ] Crear `pokedeck-udi/docs/api-contract.md` con ejemplo de request/response.
...
**Descripción**
Mejorar `pokedeck-udi/public/index.html` con navbar y secciones que expliquen la app.
...
**Descripción**
Crear UI para login/crear usuario (nombre, email) en `pokedeck-udi/public/users.html`.
...
- [ ] Redirigir a `pokedeck-udi/public/decks.html`.
...
**Descripción**
Crear modelos `Deck` y `DeckPokemon` en `pokedeck-udi/prisma/schema.prisma`.
...
**Descripción**
Implementar `GET /api/decks?userId=` en `pokedeck-udi/src/routes/decks.routes.js`.

**Checklist**
- [ ] Crear/editar `pokedeck-udi/src/routes/decks.routes.js`.
...
**Checklist**
- [ ] Documentar endpoints útiles en `pokedeck-udi/docs/pokeapi-plan.md`.
